...
<body style="background-color:#F0F0F0;">
    ...
    $(document).on("click", "#terminal_modal", function() {
        ...
        var new_href = "changeTerminal.php?terminal=" + terminal + "&plan=" + plan;
    ...
    <div class="mx-12">
        ...
        <h2 class="text-3xl mb-3 font-bold text-red-600">View Users - <?= $plan ?>$ Plan</h2>
        <h6><a href="viewuserstoday.php">View Today's Users</a></h6>
        <h6><a href="view-users-earning-wise.php?plan=<?= $plan ?>&earning=70&time=2">View Users Earning Wise</a></h6>
        ...
        <div class="container">
                    ...
                    <div class="dropdown show" style="float: right;">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            ...
                            <a class="dropdown-item"
                                href="viewusers-plan.php?<?= http_build_query(array_merge($_GET, array('sort' => 'earninghigh')))  ?>">Earning
                                - High
                                to Low</a>
                            <a class="dropdown-item"
                                href="viewusers-plan.php?<?= http_build_query(array_merge($_GET, array('sort' => 'earninglow'))) ?>">Earning
                                - Low to
                                High</a>

                            <a class="dropdown-item"
                                href="viewusers-plan.php?<?= http_build_query(array_merge($_GET, array('sort' => 'extra-asc'))) ?>">Extra
                                time - Low to
                                High</a>
                            <a class="dropdown-item"
                                href="viewusers-plan.php?<?= http_build_query(array_merge($_GET, array('sort' => 'extra-desc'))) ?>">Extra
                                time - High to
                                Low</a>

                            <a class="dropdown-item"
                                href="viewusers-plan.php?<?= http_build_query(array_merge($_GET, array('sort' => '5dollar'))) ?>">Earning
                                greater than
                                10 $</a>
                            <a class="dropdown-item"
                                href="viewusers-plan.php?<?= http_build_query(array_merge($_GET, array('sort' => 'web'))) ?>">Sort
                                by
                                Web</a>
                            <a class="dropdown-item"
                                href="viewusers-plan.php?<?= http_build_query(array_merge($_GET, array('sort' => 'app'))) ?>">Sort
                                by
                                App</a>
                            <a class="dropdown-item"
                                href="viewusers-plan.php?<?= http_build_query(array_merge($_GET, array('sort' => 'both'))) ?>">Sort
                                by
                                Both</a>
                            <a class="dropdown-item"
                                href="viewusers-plan.php?<?= http_build_query(array_merge($_GET, array('sort' => 'date'))) ?>">Sort
                                by
                                Date</a>
            ...
            <div class="row">
                <?php
                $sql_total = "select COUNT(id) as total_users, SUM(total_earning) as total_earning from users where captcha_count = $plan";
        ...
        <div class="flex flex-row bg-white rounded-full shadow-md place-content-around w-full mb-3 p-2">
            <a class="btn bg-darkslateblue text-white shadow-md rounded-full w-10 h-10" style="margin: 5px;"
                href="?<?= http_build_query(array_merge($_GET, array('page' => "A"))) ?>">A
            </a>
            <a class="btn bg-darkslateblue text-white shadow-md rounded-full w-10 h-10" style="margin: 5px;"
                href="?<?= http_build_query(array_merge($_GET, array('page' => "B"))) ?>">B
            </a>
            <a class="btn bg-darkslateblue text-white shadow-md rounded-full w-10 h-10" style="margin: 5px;"
                href="?<?= http_build_query(array_merge($_GET, array('page' => "C"))) ?>">C
            </a>
            <a class="btn bg-darkslateblue text-white shadow-md rounded-full w-10 h-10" style="margin: 5px;"
                href="?<?= http_build_query(array_merge($_GET, array('page' => "D"))) ?>">D
            </a>
            <a class="btn bg-darkslateblue text-white shadow-md rounded-full w-10 h-10" style="margin: 5px;"
                href="?<?= http_build_query(array_merge($_GET, array('page' => "E"))) ?>">E
            </a>
            <a class="btn bg-darkslateblue text-white shadow-md rounded-full w-10 h-10" style="margin: 5px;"
                href="?<?= http_build_query(array_merge($_GET, array('page' => "F"))) ?>">F
            </a>
            <a class="btn bg-darkslateblue text-white shadow-md rounded-full w-10 h-10" style="margin: 5px;"
                href="?<?= http_build_query(array_merge($_GET, array('page' => "G"))) ?>">G
            </a>
            <a class="btn bg-darkslateblue text-white shadow-md rounded-full w-10 h-10" style="margin: 5px;"
                href="?<?= http_build_query(array_merge($_GET, array('page' => "H"))) ?>">H
            </a>
            <a class="btn bg-darkslateblue text-white shadow-md rounded-full w-10 h-10" style="margin: 5px;"
                href="?<?= http_build_query(array_merge($_GET, array('page' => "I"))) ?>">I
            </a>
            <a class="btn bg-darkslateblue text-white shadow-md rounded-full w-10 h-10" style="margin: 5px;"
                href="?<?= http_build_query(array_merge($_GET, array('page' => "J"))) ?>">J
            </a>
            <a class="btn bg-darkslateblue text-white shadow-md rounded-full w-10 h-10" style="margin: 5px;"
                href="?<?= http_build_query(array_merge($_GET, array('page' => "K"))) ?>">K
            </a>
            <a class="btn bg-darkslateblue text-white shadow-md rounded-full w-10 h-10" style="margin: 5px;"
                href="?<?= http_build_query(array_merge($_GET, array('page' => "L"))) ?>">L
            </a>
            <a class="btn bg-darkslateblue text-white shadow-md rounded-full w-10 h-10" style="margin: 5px;"
                href="?<?= http_build_query(array_merge($_GET, array('page' => "M"))) ?>">M
            </a>
            <a class="btn bg-darkslateblue text-white shadow-md rounded-full w-10 h-10" style="margin: 5px;"
                href="?<?= http_build_query(array_merge($_GET, array('page' => "N"))) ?>">N
            </a>
            <a class="btn bg-darkslateblue text-white shadow-md rounded-full w-10 h-10" style="margin: 5px;"
                href="?<?= http_build_query(array_merge($_GET, array('page' => "O"))) ?>">O
            </a>
            <a class="btn bg-darkslateblue text-white shadow-md rounded-full w-10 h-10" style="margin: 5px;"
                href="?<?= http_build_query(array_merge($_GET, array('page' => "P"))) ?>">P
            </a>
            <a class="btn bg-darkslateblue text-white shadow-md rounded-full w-10 h-10" style="margin: 5px;"
                href="?<?= http_build_query(array_merge($_GET, array('page' => "Q"))) ?>">Q
            </a>
            <a class="btn bg-darkslateblue text-white shadow-md rounded-full w-10 h-10" style="margin: 5px;"
                href="?<?= http_build_query(array_merge($_GET, array('page' => "R"))) ?>">R
            </a>
            <a class="btn bg-darkslateblue text-white shadow-md rounded-full w-10 h-10" style="margin: 5px;"
                href="?<?= http_build_query(array_merge($_GET, array('page' => "S"))) ?>">S
            </a>
            <a class="btn bg-darkslateblue text-white shadow-md rounded-full w-10 h-10" style="margin: 5px;"
                href="?<?= http_build_query(array_merge($_GET, array('page' => "T"))) ?>">T
            </a>
            <a class="btn bg-darkslateblue text-white shadow-md rounded-full w-10 h-10" style="margin: 5px;"
                href="?<?= http_build_query(array_merge($_GET, array('page' => "U"))) ?>">U
            </a>
            <a class="btn bg-darkslateblue text-white shadow-md rounded-full w-10 h-10" style="margin: 5px;"
                href="?<?= http_build_query(array_merge($_GET, array('page' => "V"))) ?>">V
            </a>
            <a class="btn bg-darkslateblue text-white shadow-md rounded-full w-10 h-10" style="margin: 5px;"
                href="?<?= http_build_query(array_merge($_GET, array('page' => "W"))) ?>">W
            </a>
            <a class="btn bg-darkslateblue text-white shadow-md rounded-full w-10 h-10" style="margin: 5px;"
                href="?<?= http_build_query(array_merge($_GET, array('page' => "X"))) ?>">X
            </a>
            <a class="btn bg-darkslateblue text-white shadow-md rounded-full w-10 h-10" style="margin: 5px;"
                href="?<?= http_build_query(array_merge($_GET, array('page' => "Y"))) ?>">Y
            </a>
            <a class="btn bg-darkslateblue text-white shadow-md rounded-full w-10 h-10" style="margin: 5px;"
                href="?<?= http_build_query(array_merge($_GET, array('page' => "Z"))) ?>">Z
            </a>
        </div>
        ...
        <form action="?plan=<?= $plan ?>" method="GET">
            <input class="rounded-full bg-white shadow-md px-4 border-0 focus:outline-none" name="page" type="text"
                name="page" type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for Users.."
        ...
        <div>
            <table class="w-full table-auto bg-white border-collapse" id="myTable">
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM users WHERE on_hold = 0 AND captcha_count = $plan and user_id like '$page' $limitQuery";
                    ...
                    if ($sort == "extra-asc")
                        $_SESSION['sort-time'] = "asc";
                    if ($sort == "extra-desc")
                        $_SESSION['sort-time'] = "desc";

                    if (isset($_SESSION['sort'])) {
                        $sql = "SELECT * FROM users WHERE on_hold = 0 AND captcha_count = $plan and user_id like '$page' order by total_earning " . $_SESSION['sort'] . " " . $limitQuery;
                    }

                    if (isset($_SESSION['sort-time'])) {
                        $sql = "SELECT * FROM users WHERE on_hold = 0 AND captcha_count = $plan and user_id like '$page' order by extra_time " . $_SESSION['sort-time'] . " " . $limitQuery;
                    }

                    if ($sort == "5dollar") {
                        $_SESSION['5dollar'] = "5dollar";
                        $sql = "SELECT * FROM users WHERE on_hold = 0 AND captcha_count = $plan and user_id like '$page' and total_earning > 10 order by total_earning desc $limitQuery";
                    }

                    if ($sort == "web") {
                        $sql = "SELECT * FROM users WHERE on_hold = 0 AND captcha_count = $plan and user_id like '$page' and platform = 'web' $limitQuery";
                    }

                    if ($sort == "app") {
                        $sql = "SELECT * FROM users WHERE on_hold = 0 AND captcha_count = $plan and user_id like '$page' and platform = 'app' $limitQuery";
                    }

                    if ($sort == "both") {
                        $sql = "SELECT * FROM users WHERE on_hold = 0 AND captcha_count = $plan and user_id like '$page' and platform = 'both' $limitQuery";
                    }

                    if ($sort == "date") {
                        $sql = "SELECT *, STR_TO_DATE(date_time, '%d-%b-%Y %h:%i:%s%p') as created_on FROM users  WHERE on_hold = 0 AND captcha_count = $plan and user_id like '$page' order by created_on desc $limitQuery";
                    }
