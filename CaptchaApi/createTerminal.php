...
if (isset($_POST['submit'])) {
    ...
    $sql = "insert into terminals (terminal) values ('$terminal')";
    if ($conn->query($sql)) {
        echo "<script>alert('Terminal Created Successfully.');</script>";
        echo "<script>window.location = 'createTerminal.php';</script>";
    }
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                ...
                <div class="card"
                    ...
                    <div class="card-body">
                        ...
                        <h3 class="font-bold text-xl ">CREATE TERMINAL</h3>
                        <hr class="my-1" />
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlFile1">Terminal No.</label>
