    ...
    <div class="container">
        ...
        <table class="w-full table-auto bg-white border-collapse" id="myTable">
            ...
            <tbody>
                ...
                $sql = "SELECT id, title, body, date_time, read_count FROM demo_messages order by id desc";
                ...
                <tr class="hover:bg-gray-100 border-b border-dashed">
                    ...
                    <td class="px-2 py-4 text-sm text-center"><?= $row["read_count"]; ?> Users</td>
                    <td class="px-2 py-4 text-sm text-center">
                        <a href="sendMsgDemo.php?message_id=<?= $row["id"]; ?>"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="deleteMsgDemo.php?message_id=<?= $row["id"]; ?>" type="button"
