...
{	
	...
	public function phpcaptcha($text, $captcha_type, $fileName, $textColor, $backgroundColor,$imgWidth,$imgHeight,$noiceLines=0,$noiceDots=0,$noiceColor='#162453')
	{	
		/* Settings */
		//$text=$this->random();
		$fonts;
		...
		{
		    $fonts = array("Allura.ttf","Arizonia.ttf", "Bonbon.ttf","monofont.ttf", "1942.ttf", "ASS.TTF", "BATMOS.TTF", "carbontype.ttf", "CONFIGUR.TTF", "Playdough.ttf", "RattyTatty.ttf", "Swirled2.ttf");
		}
		else{
		    $fonts = array("Allura.ttf","Arizonia.ttf","Barrio.ttf","Bonbon.ttf","monofont.ttf", "1942.ttf", "ADAMN.TTF", "ASS.TTF", "BATMOS.TTF", "boston_traffic.ttf", "carbontype.ttf", "CONFIGUR.TTF", "edo.ttf", "EraserRegular.ttf", "Inch75.ttf", "lilac_malaria.ttf", "nervous_rex.ttf", "papercut.ttf", "Playdough.ttf", "PREVIEWA.TTF", "quick_end_jerk.ttf", "RattyTatty.ttf", "scandal.ttf", "SERAPHIM.TTF", "Swirled2.ttf", "zero_and_zero_is.ttf");
		}
		$random_keys = array_rand($fonts);
		$font = './fonts/'.$fonts[$random_keys];/* font */
		$textColor=$this->hexToRGB($textColor);	
		$fontSize = $imgHeight * 0.40;
		...
		imagejpeg($im,"includes/uploads/".$fileName,90);/* Showing image */
