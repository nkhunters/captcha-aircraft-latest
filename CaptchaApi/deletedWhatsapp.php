...
if (isset($_POST['submit'])) {
    $userId = $_POST['userId'];
    $sql = "delete from demo_whatsapp_contacts where id = '$userId'";
    if ($conn->query($sql)) {
...
if (isset($_POST['deleteAll'])) {
    $sql = "truncate table demo_whatsapp_contacts";
    if ($conn->query($sql)) {
        header('Location: ' . $_SERVER['REQUEST_URI']);
    }
}
...
<head>
    <meta charset="utf-8" />
    <title>Deleted Whatsapp Numbers</title>
...
<body style="background-color:#F0F0F0;">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="recoverAllWhatsapp.php" id="terminal" class="btn text-white bg-darkslateblue">Yes
                        Recover!</a>
                </div>
    ...
    <div class="mx-12">
        <h2 class="text-3xl mb-3 font-bold">Deleted Whatsapp Numbers</h2>
        ...
        <?php
            ...
            $sql_total = "select COUNT(id) as total_users from demo_whatsapp_contacts where isDeleted = 1";
            ...
            if (isset($_GET['sort']) && $_GET['sort'] == "app")
                $sql_total = "SELECT COUNT(id) as total_user FROM demo_whatsapp_contacts WHERE platform='app' and " . $whereClause . " order by id desc $limitQuery";

            if (isset($_GET['sort']) && $_GET['sort'] == "web")
                $sql_total = "SELECT COUNT(id) as total_user FROM demo_whatsapp_contacts WHERE platform='web' and " . $whereClause . " order by id desc $limitQuery";

            if (isset($_GET['sort']) && $_GET['sort'] == "form")
                $sql_total = "SELECT COUNT(id) as total_user FROM demo_whatsapp_contacts WHERE platform='form' and " . $whereClause . " order by id desc $limitQuery";
        ...
        <h5 class="text-xl font-semibold">Total Numbers :- <?= $total_users; ?></h5>
        ...
        <table class="w-full table-auto bg-white border-collapse" id="myTable">
            ...
            <tbody>
                <?php
                    ...
                    $sql2 = "SELECT * FROM demo_whatsapp_contacts WHERE " . $whereClause . " order by id desc $limitQuery";

                    if (isset($_GET['sort']) && $_GET['sort'] == "app")
                        $sql2 = "SELECT * FROM demo_whatsapp_contacts WHERE platform='app' and " . $whereClause . " order by id desc $limitQuery";

                    if (isset($_GET['sort']) && $_GET['sort'] == "web")
                        $sql2 = "SELECT * FROM demo_whatsapp_contacts WHERE platform='web' and " . $whereClause . " order by id desc $limitQuery";

                    if (isset($_GET['sort']) && $_GET['sort'] == "form")
                        $sql2 = "SELECT * FROM demo_whatsapp_contacts WHERE platform='form' and " . $whereClause . " order by id desc $limitQuery";
                    ...
                    <td class="px-2 py-4 text-sm text-center">
                        ...
                        <div class="modal fade" id="removeHold<?= $j; ?>" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Recover number</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="recoverWhatsapp.php?id=<?= $row["id"]; ?>" type="button"
