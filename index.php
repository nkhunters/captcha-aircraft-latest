...
$sql2 = "select mobile, email, showContent, isWhatsappEnabled from support_details where id = 1";
...
<body class="bg-gradient-to-r from-blueviolet to-darkslateblue">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                    ...
                    <form id="whatsapp-form" class="" method="post" action="save-whatsapp.php">
                        ...
                        <div class="my-12">
                            <div class="form-gp">
                                ...
                                <input class="" type="text" maxlength="10" minlength="10" id="exampleInputEmail1"
                                    name="mobile" onkeypress='validate(event)' required />
                ...
                <div class="modal-footer">
                    <button type="button"
                        class="btn bg-gray-600 text-white font-semibold rounded-md shadow-md py-2 px-3"
                        data-dismiss="modal">Close</button>
                    <button type="submit" name="submit" value="submit" form="whatsapp-form"
                        class="bg-red-600 text-white font-semibold rounded-md shadow-md py-2 px-3">Continue</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="flex h-screen container w-9/12">
                ...
                <div class="flex">
                    <div class="hidden lg:block w-3/5 flex items-center justify-center">
                        <div class="flex flex-col items-center content-between">
                            <img class="mt-20" src="bg.svg" width="350" alt="My Happy SVG" />
                            ...
                            <span class="mt-12 text-base text-center">
                                ...
                                <a href="https://api.whatsapp.com/send?phone=91<?= $mobile ?>&text=Hi, Aircraft Captcha Services, i want to enquire about your plans"
                                    target="_blank" class="font-medium text-white">+91
                                    <?= $mobile ?></a> or
                                E-mail us at
                    ...
                    <div
                        class="bg-white rounded-3xl lg:rounded-none lg:rounded-tr-3xl lg:rounded-br-3xl w-full lg:w-1/2 p-6 flex items-center justify-center">
                        <form class="" method="post" action="">
                            ...
                            <div class="my-12">
                                <div class="form-gp">
                                    ...
                                    <input class="uppercase" type="text" id="exampleInputEmail1" name="username"
                                        required />
                                    <i class="ti-email"></i>
                                </div>
                                <div class="form-gp">
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="defaultCheck1">
                                        I agree to the <a href="terms.php" target="_blank">rules & regulations</a>,
                                        agreement and details which
                                        I have received
                                        via E-mail from Aircraft Data Entry.
                                    </label>
                                </div>
                                <br />
                                <br>
                                ...
                                <button
                                    class="bg-gradient-to-r from-mediumslateblue to-mediumpurpule rounded-3xl py-2 px-12 mx-auto flex items-center justify-center text-center text-xl font-medium text-white"
                                    type="submit" name="submit" value="submit">
                                    Login
                                </button>
                                <!-- <br>
                                <a id="demo-btn-modal" class="text-center font-medium rounded-full py-2 px-4 mx-auto flex items-center justify-center text-center border border-gray-200 bg-lightPink" data-toggle="modal" href="#deleteModal"><span class="text-white font-bold">Click here to
                                        try the demo</a>
                                ...
                                <div class="lg:hidden mt-6 text-sm text-center">
                                    For more details please WhatsApp us at
                                    <a href="https://api.whatsapp.com/send?phone=91<?= $mobile ?>&text=Hi, Aircraft Captcha Services, i want to enquire about your plans"
                                        target="_blank" class="font-medium text-lightPink">+91
                                        <?= $mobile ?></a> or
                                    E-mail us at
        ...
        <a href="https://api.whatsapp.com/send?phone=91<?= $mobile; ?>&text=Hi, Aircraft Captcha Services, i want to enquire about your plans"
            target="_blank">
            <img class="fixed shadow-2xl right-6 bottom-6 lg:right-8 lg:bottom-8 z-50" src="whatsapp.png"
                width="50" /></a>
        <?php
